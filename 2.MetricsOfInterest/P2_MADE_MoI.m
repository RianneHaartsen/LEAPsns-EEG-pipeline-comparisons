%% LEAP soc-nsoc videos Pipelines: get power and connectivity values from the data preprocessed with the MADE pipeline 
% P2 - pipeline 2 in the manuscript

% This script takes the data processed with the MADE pipeline and converges
...
% MADE_preprocessing_report.mat file. Preprocessed data are saved. 
% The measures of interest are stored into a reporting table named
% MADE_MOI_table and saved as MADE_MeasuresOfInterest_report.mat. 
...
% Adapted by Rianne Haartsen, PhD.; 04-2022 
...
ft_defaults
addpath(genpath('xxx/Preproc_MADE')) % any additional folders needed. 

load xxx/Preproc_MADE/MADE_preprocessing_report.mat

Pow_location = 'xxx/Preproc_MADE/A_Power_data';
FC_location = 'xxx/Preproc_MADE/B_FC_data';
output_location = 'xxx/Preproc_MADE';
Fig_location = 'xxx/Preproc_MADE/Report_figs';


for subject = 1: height(MADE_report_table)
    
    CurrID = MADE_report_table.ID{subject};
    
    fprintf('\n\n\n*** Processing subject %d (%s) ***\n\n\n', subject, CurrID);
    
    try
        % load preprocessed data
        filename_path_preproc = MADE_report_table.path_preproc{subject};
    ...
    MADE_MOI_table(subject,:) = data_table_newrow;
    save('MADE_MeasuresOfInterest_report.mat','MADE_MOI_table');
